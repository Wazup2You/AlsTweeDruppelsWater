      ...
      <div className="w-screen h-screen bg-white flex flex-col items-center justify-center">
        <div className="absolute mb-60">
          ...
          <div className="contents">
            <div className={scene === 0 ? "hidden" : "flex justify-center"} >
              <Button text="Visuals" onClick={() => setScene(0)} />
            </div>
            <div className={scene === 1 || scene === 4 || scene === 5 ? "hidden" : "flex justify-center"} >
              <Button text="Test je kennis" onClick={() => setScene(1)} />
            </div>
            <div className={scene === 2 ? "hidden" : "flex justify-center"} >
              <Button text="Tips" onClick={() => setScene(2)} />
            </div>
            <div className={scene === 3 ? "hidden" : "flex justify-center"} >
        ...
        <div className="absolute w-10/12">
          <div className= {scene === 4 || scene === 5 ? "p-10 block flex justify-between"  : "hidden"}>
